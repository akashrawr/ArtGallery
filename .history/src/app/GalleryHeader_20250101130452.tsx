...
type GalleryHeaderProps = {
  openModal: () => void;
  navigateToLogin: () => void; // Add this prop type
};

const GalleryHeader: React.FC<GalleryHeaderProps> = ({ openModal, navigateToLogin }) => {
  return (
    <div className="mb-6 pl-2 border-b-8 border-blue-800 flex items-center lg:items-stretch flex-row">
      ...
      <div className="justify-end flex flex-1 pt-4 pr-8 pb-4">
        ...
        {/* User Login Button */}
        <button
          onClick={navigateToLogin} // Call navigateToLogin when clicked
