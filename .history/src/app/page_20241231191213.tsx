...
export default function Gallery() {
  ...
  function openModal() {
    // Removed the navigator.share function
    setIsOpen(true);
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mb-6 pl-2 border-b-8 border-green-800 flex items-center lg:items-stretch flex-row bg-gradient-to-r from-[#7CB9E8] to-[#00308F]">
