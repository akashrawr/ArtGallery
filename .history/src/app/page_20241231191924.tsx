  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <h1 className="select-none transition inline-block p-2 text-5xl bg-gradient-to-tr from-blue-800 to-blue-500 text-transparent bg-clip-text font-extrabold">
        ArtyFiji
        </h1>
