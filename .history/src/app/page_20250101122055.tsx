...
{/* User Login Button */}
<button
  className="hover:scale-110 focus:outline-none flex justify-center items-center rounded cursor-pointer hover:bg-blue-700 hover:text-blue-100 bg-blue-50 text-blue-700 border duration-200 ease-in-out border-blue-600 transition w-8 h-8"
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
