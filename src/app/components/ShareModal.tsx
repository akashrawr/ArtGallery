...
const ShareModal = ({ isOpen, closeModal }: { isOpen: boolean; closeModal: () => void }) => {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
                    ...
                    <input className="w-full outline-none bg-transparent" type="text" value="https://artyfiji.vercel.app/" readOnly />
